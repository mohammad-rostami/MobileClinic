...
public class E_BurningActivity extends SourceActivity {

    @Override
    public void onBackPressed() {
        Intent intent = new Intent(E_BurningActivity.this, EmergencyActivity.class);
        E_BurningActivity.this.startActivity(intent);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.e_burning);
        ...
        Button02.setBackgroundColor(Color.parseColor("#eeeeee"));
        Button02.setTextColor(Color.parseColor("#bc1111"));
        ...
        btnmenu2.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(E_BurningActivity.this, DiagnosisActivity.class);
                E_BurningActivity.this.startActivity(intent);
                finish();
            }
        });
        ...
        btnmenu3.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(E_BurningActivity.this, AboutActivity.class);
                E_BurningActivity.this.startActivity(intent);
                finish();
            }
        });
        ...
        Button01.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(E_BurningActivity.this, TextActivity.class);
        ...
        Button04.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(E_BurningActivity.this, E_BasicSupportActivity.class);
                E_BurningActivity.this.startActivity(intent);
                finish();
            }
        });
        ...
        Button07.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(E_BurningActivity.this, E_HeadHurtActivity.class);
                E_BurningActivity.this.startActivity(intent);
                finish();
            }
        });
        Button08.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(E_BurningActivity.this, E_ChestHurtActivity.class);
                E_BurningActivity.this.startActivity(intent);
                finish();
            }
        });
        Button09.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(E_BurningActivity.this, E_AtelBandiActivity.class);
                E_BurningActivity.this.startActivity(intent);
                finish();
            }
        });
        ...
        /** attention - main code */
        Button electric_burn = (Button) findViewById(R.id.electric_burn);
        Button thermal_burn = (Button) findViewById(R.id.thermal_burn);
        Button chemical_burn = (Button) findViewById(R.id.chemical_burn);

        electric_burn.setTypeface(yekanfont);
        thermal_burn.setTypeface(yekanfont);
        chemical_burn.setTypeface(yekanfont);
        electric_burn.setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(E_BurningActivity.this, TextActivity.class);
                intent.putExtra("txt", "file:///android_asset/electric_burn.html");
                intent.putExtra("actionbartxt1", "سوختگی الکتریکی");
                E_BurningActivity.this.startActivity(intent);
                finish();
            }
        });
        thermal_burn.setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(E_BurningActivity.this, TextActivity.class);
                intent.putExtra("txt", "file:///android_asset/thermal_burn.html");
                intent.putExtra("actionbartxt1", "سوختگی حرارتی");
                E_BurningActivity.this.startActivity(intent);
                finish();
            }
        });
        chemical_burn.setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(E_BurningActivity.this, TextActivity.class);
                intent.putExtra("txt", "file:///android_asset/chemical_burn.html");
                intent.putExtra("actionbartxt1", "سوختگی شیمیایی");
                E_BurningActivity.this.startActivity(intent);
                finish();
            }
        });
