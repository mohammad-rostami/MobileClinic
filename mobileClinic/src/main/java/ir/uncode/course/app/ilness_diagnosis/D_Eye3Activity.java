...
public class D_Eye3Activity extends SourceActivity {
    ...
    public void onBackPressed() {
        ...
        cursor2.close();
        Intent intent = new Intent(D_Eye3Activity.this, D_Eye2Activity.class);
        D_Eye3Activity.this.startActivity(intent);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.d_eye3);
        ...
        txtmenu6.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(D_Eye3Activity.this, DiagnosisActivity.class);
                D_Eye3Activity.this.startActivity(intent);
                finish();
            }
        });
        ...
        btnmenu1.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(D_Eye3Activity.this, EmergencyActivity.class);
                D_Eye3Activity.this.startActivity(intent);
                finish();
            }
        });
        btnmenu3.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(D_Eye3Activity.this, AboutActivity.class);
                D_Eye3Activity.this.startActivity(intent);
                finish();
            }
        });
        ...
        Button01.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(D_Eye3Activity.this, TextActivity.class);
        ...
        Button02.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(D_Eye3Activity.this, E_BurningActivity.class);
                D_Eye3Activity.this.startActivity(intent);
                finish();
            }
        });
        ...
        Button04.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(D_Eye3Activity.this, E_BasicSupportActivity.class);
                D_Eye3Activity.this.startActivity(intent);
                finish();
            }
        });
        ...
        Button07.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(D_Eye3Activity.this, E_HeadHurtActivity.class);
                D_Eye3Activity.this.startActivity(intent);
                finish();
            }
        });
        Button08.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(D_Eye3Activity.this, E_ChestHurtActivity.class);
                D_Eye3Activity.this.startActivity(intent);
                finish();
            }
        });
        Button09.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(D_Eye3Activity.this, E_AtelBandiActivity.class);
                D_Eye3Activity.this.startActivity(intent);
                finish();
            }
        });
        Button10.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(D_Eye3Activity.this, E_BimariActivity.class);
                D_Eye3Activity.this.startActivity(intent);
                finish();
            }
        });
        ...
        btnanswer.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (chb1.isChecked())
                {
                    Cursor Astigmatism = G.database.rawQuery("UPDATE eye SET score = score + 3 Where Name = 'آستیگماتیسم'", null);
                    while (Astigmatism.moveToNext()) {}
                    Astigmatism.close();
                    Cursor Cataract = G.database.rawQuery("UPDATE eye SET score = score + 1 Where Name = 'آب مروارید'", null);
                    while (Cataract.moveToNext()) {}
                    Cataract.close();
                }
                else if (chb2.isChecked())
                {
                    ...
                    while (Astigmatism.moveToNext()) {}
                    Astigmatism.close();
                    Cursor Glaucoma = G.database.rawQuery("UPDATE eye SET score = score + 2 Where Name = 'آب سیاه'", null);
                    while (Glaucoma.moveToNext()) {}
                    Glaucoma.close();
                }
                else if (chb3.isChecked())
                {
                    Cursor Cataract = G.database.rawQuery("UPDATE eye SET score = score + 3 Where Name = 'آب مروارید'", null);
                    while (Cataract.moveToNext()) {}
                    Cataract.close();
                }
                else if (chb4.isChecked())
                {
                    Cursor Cataract = G.database.rawQuery("UPDATE eye SET score = score + 3 Where Name = 'بلفاریت'", null);
                    while (Cataract.moveToNext()) {}
                    Cataract.close();
                }
                else if (chb5.isChecked())
                {
                    Cursor Blepharitis = G.database.rawQuery("UPDATE eye SET score = score + 3 Where Name = 'بلفاریت'", null);
                    while (Blepharitis.moveToNext()) {}
                    Blepharitis.close();
                }
                else if (chb6.isChecked())
                {
                    Cursor Keratoconjunctivitis = G.database.rawQuery("UPDATE eye SET score = score + 2 Where Name = 'کراتوکنژنکتیویت بهاره'", null);
                    while (Keratoconjunctivitis.moveToNext()) {}
                    Keratoconjunctivitis.close();
                    Cursor Uveitis = G.database.rawQuery("UPDATE eye SET score = score + 3 Where Name = 'يوئيت'", null);
                    while (Uveitis.moveToNext()) {}
                    Uveitis.close();
                }
                ...
                {
                    Cursor sicca = G.database.rawQuery("UPDATE eye SET score = score + 2 Where Name = 'خشک چشمی'", null);
                    while (sicca.moveToNext()) {}
                    sicca.close();
                }
                else if (chb9.isChecked())
                {

                    Cursor Glaucoma = G.database.rawQuery("UPDATE eye SET score = score + 3 Where Name = 'آب سیاه'", null);
                    while (Glaucoma.moveToNext()) {}
                    Glaucoma.close();
                    Cursor Cataract = G.database.rawQuery("UPDATE eye SET score = score + 3 Where Name = 'آب مروارید'", null);
                    while (Cataract.moveToNext()) {}
                ...
                {
                    Cursor Cataract = G.database.rawQuery("UPDATE eye SET score = score + 2 Where Name = 'آب مروارید'", null);
                    while (Cataract.moveToNext()) {}
                    Cataract.close();
                    Cursor sicca = G.database.rawQuery("UPDATE eye SET score = score + 3 Where Name = 'خشک چشمی'", null);
                    while (sicca.moveToNext()) {}
                    sicca.close();
                } else {
                ...
                Intent intent = new Intent(D_Eye3Activity.this, D_AnswerActivity.class);
                intent.putExtra("txt", "eye");
                D_Eye3Activity.this.startActivity(intent);
                finish();
            }
        });
